...
function setUserAgent() {
  if (!shopify_api_1.default.Context.USER_AGENT_PREFIX) {
    shopify_api_1.default.Context.USER_AGENT_PREFIX =
      exports.KOA_USER_AGENT_PREFIX;
  } else if (
    !shopify_api_1.default.Context.USER_AGENT_PREFIX.includes(
      exports.KOA_USER_AGENT_PREFIX,
    )
  ) {
    shopify_api_1.default.Context.USER_AGENT_PREFIX = ''
      .concat(shopify_api_1.default.Context.USER_AGENT_PREFIX, ' | ')
      .concat(exports.KOA_USER_AGENT_PREFIX);
  }
}
